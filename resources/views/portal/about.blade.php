            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="row g-0 about-bg rounded overflow-hidden">
                    <div class="col-6 text-start">
                        <img class="img-fluid" src="{{ asset('assets/portal/company/pic1.jpeg') }}">
                    </div>
                    <div class="col-6 text-end">
                        <img class="img-fluid w-100" src="{{ asset('assets/portal/company/pic4.jpeg') }}" style="width: 85%;">
                    </div>
                    <div class="col-6 text-start">
                        <img class="img-fluid" src="{{ asset('assets/portal/company/pic3.jpeg') }}">
                    </div>
                    <div class="col-6 text-end">
                        <img class="img-fluid w-100" src="{{ asset('assets/portal/company/pic2.jpeg') }}" style="width: 85%;">
                    </div>
                </div>
                <div class="row">
                     <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="team text-center rounded p-3 py-4">
                            <img src="{{ asset('assets/portal/company/Dr.Vishwesh-Thakare.jpeg') }}" class="img-fluid avatar avatar-medium shadow rounded-pill" alt="">
                            <div class="content mt-3">
                                <h4 class="title mb-0">Dr.Vishwesh Thakare</h4>
                                <small class="text-muted">Founder & COO</small>
                                <!--end icon-->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="team text-center rounded p-3 py-4">
                            <img src="{{ asset('assets/portal/company/Dr.Somesh-Mane.jpeg') }}" class="img-fluid avatar avatar-medium shadow rounded-pill" alt="">
                            <div class="content mt-3">
                                <h4 class="title mb-0">Dr.Somesh Mane</h4>
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mt-4 pt-2">
                        <div class="team text-center rounded p-3 py-4">
                            <img src="{{ asset('assets/portal/company/Dr.Shubham-Munde.jpeg') }}" class="img-fluid avatar avatar-medium shadow rounded-pill" alt="">
                            <div class="content mt-3">
                                <h4 class="title mb-0">Dr.Shubham Munde</h4>
